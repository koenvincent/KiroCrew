...
cleared, the pending queue is dropped, and the session is reset. You will see
"⏹ Execution stopped." when a running turn was cancelled, or
"⛔ Execution stopped — session reset." when there was nothing to cancel.
