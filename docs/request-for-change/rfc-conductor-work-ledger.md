...
is refused a little early rather than a little late. For non-ASCII text that is
roughly ten thousand characters of acceptance, decision or summary per write. An
